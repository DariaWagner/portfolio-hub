...
# =========================
st.set_page_config(
    page_title="Daria Wagner - Portfolio & CV",
    page_icon="📘",
    layout="wide"
)
...
# =========================
    ...
    with col2:
        ...
        st.write("""
                Zurzeit befinde ich mich in der Umschulung zur Fachinformatikerin für Daten- und Prozessanalyse. 
                Dabei verbinde ich meine praktische Erfahrung aus der Produktion mit modernen Methoden der Datenanalyse. 
                Ich lerne, Daten systematisch zu erfassen, zu strukturieren und auszuwerten, um Prozesse transparenter 
                und effizienter zu machen.
                """)

        st.write("""
                Mein beruflicher Weg führte mich von Russland nach Deutschland. 
                Diese Veränderung hat mich persönlich und beruflich stark geprägt. In Deutschland konnte ich bei 
                Beckhoff Automation wertvolle Einblicke in industrielle Abläufe, Produktionsprozesse und Qualitätssicherung gewinnen. 
                Dort habe ich gelernt, wie wichtig präzise Arbeit, klare Strukturen und Teamarbeit für stabile Prozesse sind.
                """)

        st.write("""
                Heute nutze ich dieses Praxiswissen gezielt, um Produktions- und Prozessdaten so aufzubereiten, 
                dass daraus fundierte, verständliche und umsetzbare Entscheidungen entstehen. Mir ist wichtig, 
                nicht nur Zahlen zu analysieren, sondern auch die Abläufe dahinter zu verstehen. So kann ich Zusammenhänge erkennen, 
                Optimierungspotenziale aufzeigen und zur kontinuierlichen Verbesserung beitragen.
                """)

        st.write("""
                Ich arbeite strukturiert, verantwortungsbewusst und detailorientiert. Gleichzeitig interessiere ich mich 
                für digitale Lösungen, Automatisierung und effiziente Prozessgestaltung. Mein Ziel ist es, Unternehmen 
                dabei zu unterstützen, datenbasierte Entscheidungen sicher und nachhaltig zu treffen.
                """)
...
# =========================
    ...
    st.info("💡 **Zertifikate stehen als PDF zum Download bereit.")
